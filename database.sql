...
-- Insert sample data
INSERT INTO " . getTableName('users') . " (username, email, password_hash, user_level, bio) VALUES
...
INSERT INTO " . getTableName('posts') . " (user_id, content, image_url) VALUES
...
INSERT INTO " . getTableName('comments') . " (post_id, user_id, content) VALUES
...
INSERT INTO " . getTableName('likes') . " (post_id, user_id) VALUES
                                         (1, 2), (1, 3),
                                         (2, 1), (2, 3),
                                         (3, 1), (3, 2);