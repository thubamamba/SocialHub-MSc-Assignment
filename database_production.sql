-- SynCNet Database Schema for School Environment

USE sql2311168;

-- Users table with prefix
CREATE TABLE syncnet_users (
...
-- Posts table with prefix
CREATE TABLE syncnet_posts (
                               id INT AUTO_INCREMENT PRIMARY KEY,
                               ...
                               created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                               updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
                               FOREIGN KEY (user_id) REFERENCES syncnet_users(id) ON DELETE CASCADE
);

-- Comments table with prefix
CREATE TABLE syncnet_comments (
                                  id INT AUTO_INCREMENT PRIMARY KEY,
                                  post_id INT NOT NULL,
                                  user_id INT NOT NULL,
                                  content TEXT NOT NULL,
                                  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                                  FOREIGN KEY (post_id) REFERENCES syncnet_posts(id) ON DELETE CASCADE,
                                  FOREIGN KEY (user_id) REFERENCES syncnet_users(id) ON DELETE CASCADE
);

-- Likes table with prefix
CREATE TABLE syncnet_likes (
                               id INT AUTO_INCREMENT PRIMARY KEY,
                               post_id INT NOT NULL,
                               user_id INT NOT NULL,
                               created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
-- Insert sample data with prefixed tables
INSERT INTO syncnet_users (username, email, password_hash, user_level, bio) VALUES
...
INSERT INTO syncnet_posts (user_id, content, image_url) VALUES
...
INSERT INTO syncnet_comments (post_id, user_id, content) VALUES
...
INSERT INTO syncnet_likes (post_id, user_id) VALUES
                                                 (1, 2), (1, 3),
                                                 (2, 1), (2, 3),
                                                 (3, 1), (3, 2);